...
.PHONY: all clean test test-smoke test-pack-loader test-contract test-app-contract \
	...
	test-panel-policy-contract test-profile-interaction-contract test-datalab-folder-picker test-image-residency-contract test-raster-generation-contract test-render-perf-diag-contract test-native-image-policy-contract test-async-decode-contract test-thumbnail-decode-contract test-linux-launcher-contract test-package-boundary \
	test-image-overlay-identity-contract test-native-image-profile-wave-contract \
